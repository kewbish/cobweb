    ...
    if (parsed.error) {
      ...
      Object.keys(parsed.argv).forEach((key) => {
        if (positionalKeys.includes(key)) {
          ...
          if (!Object.hasOwnProperty.call(defaults, key) && Object.hasOwnProperty.call(argv, key) && Object.hasOwnProperty.call(parsed.argv, key) && (Array.isArray(argv[key]) || Array.isArray(parsed.argv[key]))) {
  ...
  optionCompletions(completions, args, argv, current) {
    if ((current.match(/^-/) || current === "" && completions.length === 0) && !this.previousArgHasChoices(args)) {
      ...
      Object.keys(options.key).forEach((key) => {
        ...
        if (!isPositionalKey && !options.hiddenOptions.includes(key) && !this.argsContainKey(args, argv, key, negable)) {
